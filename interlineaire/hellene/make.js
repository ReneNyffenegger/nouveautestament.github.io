...
database_fr	= fichier1.readFileSync('../../database/database_el.txt', 'utf8').split(/\r?\n/);
sebastien	= fichier1.readFileSync('../../database/sebastien_te.txt', 'utf8').replace(/=\S+=\S+/g,'').split(/\r?\n/);
...
//check wait loop
	...
	if ( linedb == database_fr.length-1 )
	{
		waitse = 0
	}
...
backverset	= verset;
	...
	//console.log(lcvmath+' : '+lcvse+' : '+lcvdb)
	//console.log(+linese+' == '+sebastien.length+' == '+linedb+' == '+database_fr.length)
